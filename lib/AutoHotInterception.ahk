...
class AutoHotInterception {
	...
	__New() {
		...
		if (A_IsCompiled){
			...
			FileCreateDir, Lib
			FileInstall, D:\Coding\AHK-Madness\lib\AutoHotInterception.dll, D:\Coding\AHK-Madness\lib\AutoHotInterception.dll
			if (bitness == "x86"){
				FileCreateDir, Lib\x86
				FileInstall, D:\Coding\AHK-Madness\lib\x86\interception.dll, D:\Coding\AHK-Madness\lib\x86\interception.dll
			} else {
				FileCreateDir, Lib\x64
				FileInstall, D:\Coding\AHK-Madness\lib\x64\interception.dll, D:\Coding\AHK-Madness\lib\x64\interception.dll
			}
		} else {
